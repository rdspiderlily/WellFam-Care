...
from MidwifeAide_Controllers.MA_AppointmentView.MA_EditApp import MAViewAppointmentDialog

class MAAppointmentController:
    ...
    def view_appointment(self, row, column):
            ...
            dialog = MAViewAppointmentDialog(app_id)  #Passing PAT_ID to View Patient Details and Forms
