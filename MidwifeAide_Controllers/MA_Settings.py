...
class MAProfileController:
    ...
    def load_ma_info(self):
        ...
        try:
            ...
            cur.execute(""" 
                ...
                WHERE s.STAFF_USN = %s AND r.ROLE_NAME IN ('Midwife', 'Nursing Aide')
            """, (self.username,))
            result = cur.fetchone()
    ...
    def view_edit_dialog(self):
        ...
        uic.loadUi("wfui/view_edit_maprofile.ui", self.profile_dialog)
        self.profile_dialog.setWindowTitle("Edit My Profile")
