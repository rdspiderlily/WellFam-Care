...
class AdminMainWindow(QDialog):
    ...
    def appointment(self):
        ...
        self.appointment_controller = AdminAppointmentController(self.tableWidApp, self.searchApp, self.sortAppCombo, self.user_id)
    ...
    def report(self):
        ...
        self.view_logs = self.findChild(QPushButton, "pushbtnLogs")
        self.report_controller = AdminReportController(self.servicesAvailed, self.lineChart, self.pregNo, self.notpregNo, self.monthlyVServ, self.view_logs)
    ...
    def settings(self):
        ...
        self.adminp_controller = AdminProfileController(self.adminPWidget, self.adminPLname, self.adminPFname, self.adminPContact, self.user_id)
